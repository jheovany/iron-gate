...
class AdminController(
    ...
    @PreAuthorize("hasRole('ADMIN')")
    fun deleteUser(@PathVariable id: Long): ResponseEntity<ApiResponse<Map<String, Any>>> {
        userService.deleteUser(id)

        val data = mapOf(
            "message" to "Usuario eliminado",
            "deletedUserId" to id
        )
    ...
    fun searchUsers(
        ...
        val pageable = PageRequest.of(page, size)
        val usersPage = userService.searchUsersByEmail(email, pageable)
